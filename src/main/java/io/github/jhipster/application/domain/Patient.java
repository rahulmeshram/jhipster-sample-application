...
public class Patient implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("genids")
    private GeneralMst cityid;

    @ManyToOne
    @JsonIgnoreProperties("genids")
    private GeneralMst stateid;

    @ManyToOne
    @JsonIgnoreProperties("genids")
    private GeneralMst natid;
    ...
    public GeneralMst getCityid() {
        return cityid;
    }

    public Patient cityid(GeneralMst generalMst) {
        this.cityid = generalMst;
        return this;
    }

    public void setCityid(GeneralMst generalMst) {
        this.cityid = generalMst;
    }

    public GeneralMst getStateid() {
        return stateid;
    }

    public Patient stateid(GeneralMst generalMst) {
        this.stateid = generalMst;
        return this;
    }

    public void setStateid(GeneralMst generalMst) {
        this.stateid = generalMst;
    }

    public GeneralMst getNatid() {
        return natid;
    }

    public Patient natid(GeneralMst generalMst) {
        this.natid = generalMst;
        return this;
    }

    public void setNatid(GeneralMst generalMst) {
        this.natid = generalMst;
    }
