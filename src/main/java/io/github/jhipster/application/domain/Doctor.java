...
public class Doctor implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("splids")
    private Specility docid;
    ...
    public Specility getDocid() {
        return docid;
    }

    public Doctor docid(Specility specility) {
        this.docid = specility;
        return this;
    }

    public void setDocid(Specility specility) {
        this.docid = specility;
    }
