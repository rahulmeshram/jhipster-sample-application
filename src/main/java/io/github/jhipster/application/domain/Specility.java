...
public class Specility implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Doctor> splids = new HashSet<>();
    ...
    public Set<Doctor> getSplids() {
        return splids;
    }

    public Specility splids(Set<Doctor> doctors) {
        this.splids = doctors;
        return this;
    }

    public Specility addSplid(Doctor doctor) {
        this.splids.add(doctor);
        doctor.setDocid(this);
        return this;
    }

    public Specility removeSplid(Doctor doctor) {
        this.splids.remove(doctor);
        doctor.setDocid(null);
        return this;
    }

    public void setSplids(Set<Doctor> doctors) {
        this.splids = doctors;
    }
